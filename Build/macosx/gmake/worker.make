...
ifeq ($(config),debug_x32)
  ...
  DEFINES += -D_DEBUG
  INCLUDES += -I../../../deps/cppzmq -I../../../deps/rxcpp/Rx/v2/src -I/usr/local/Cellar/zeromq/4.1.2/include
  FORCE_INCLUDE +=
...
ifeq ($(config),release_x32)
  ...
  LIBS += -lzmq
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -L/usr/local/Cellar/zeromq/4.1.2/lib -Wl,-x -m32
  LINKCMD = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x64)
  ...
  LIBS += -lzmq
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -L/usr/local/Cellar/zeromq/4.1.2/lib -Wl,-x -m64
  LINKCMD = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
